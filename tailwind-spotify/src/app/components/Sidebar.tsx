    ...
    return (
        <aside className="w-72 bg-zinc-950 p-6">
          ...
          <nav className="space-y-5 mt-10">
            <a href="" className="flex items-center gap-3 text-sm font-semibold text-zinc-200 hover:text-lg hover:text-zinc-50">
              <HomeIcon className="hover:text-lg hover:text-zinc-50"/>
              Home
            </a>
            <a href="" className="flex items-center gap-3 text-sm font-semibold text-zinc-200 hover:text-lg hover:text-zinc-50">
              <Search className="hover:text-lg hover:text-zinc-50"/>
              Search
            </a>
            <a href="" className="flex items-center gap-3 text-sm font-semibold text-zinc-200 hover:text-lg hover:text-zinc-50">
              <Library className="hover:text-lg hover:text-zinc-50"/>
              Your Library
            </a>
          </nav>
