...
export function Footer(){
    return (
        ...
        <div className="flex items-center gap-3 mr-20">
          <Image src="/Album.jpg" width={56} height={56} alt="Album 7 minutos"/>
          <div className="flex flex-col">
            <strong className=" text-zinc-200 font-normal hover:underline hover:text-zinc-50 hover:text-lg">Rope</strong>
        ...
        <div className="flex flex-col items-center gap-2 ml-10">
          <div className="flex items-center gap-4">
            ...
            <button className="w-10 h-10 flex items-center justify-center pl-1 rounded-full bg-white text-black">
                <Play size={20} className="text-zinc-950"/>
            </button>
